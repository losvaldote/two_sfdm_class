...
struct spectra {
  ...
  int index_tr_delta_sfdm_1;      /**< index of scalar field dark matter transfer function */
  /*Scalar Field Dark Matter 2*/
  int index_tr_delta_sfdm_2;      /**< index of scalar field dark matter transfer function */
  ...
  /*Scalar Field Dark Matter 1*/
  int index_tr_theta_sfdm_1;      /**< index of scalar field dark matter velocity transfer function */
  /*Scalar Field Dark Matter 2*/
  int index_tr_theta_sfdm_2;      /**< index of scalar field dark matter velocity transfer function */
