...
/*enum target_names {theta_s, Omega_dcdmdr, omega_dcdmdr, Omega_sfdm, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, sigma8};*/
enum target_names {theta_s, Omega_dcdmdr, omega_dcdmdr, Omega_sfdm_1, Omega_sfdm_2, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, sigma8};
